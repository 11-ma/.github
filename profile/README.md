...
| :---- | :---- | :---- |
| **dagql** | Rust, PostgreSQL | Directed Acyclic Graph Query Language \- our core data layer |
| **powerbuilder** | React, TypeScript, Vite | Solar installation management frontend |
| **powerbuilder.ai** | Python, FastAPI, Google Gemini | AI assistant service with approval-gated mutations |
...
```shell
# Start the server
cd dagql && make docker-build docker-up docker-logs
...
- **Email:** `support@11millionacres.com`  
- **Discussions:** GitHub Discussion board  
- **Leads:** Tag @eng-leads for review

---

© 2026 11 Million Acres LLC | Engineering for a Resilient Planet
